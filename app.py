...
# if "prefill"      not in st.session_state: st.session_state.prefill      = ""  # ✅ new
...
#             st.session_state.prefill = s  # ✅ save to session state
#             st.rerun()                    # ✅ force immediate rerender

#     # ── Query input ───────────────────────────────────────
#     query = st.text_area(
#         "Enter your query:",
#         value=st.session_state.prefill,   # ✅ always reads from session state
#         height=90,
...
#     # ✅ sync whatever user types back to session state
#     if query:
#         st.session_state.prefill = query

#     # ✅ always read final query from session state
#     final_query = st.session_state.prefill.strip()
...
#             research_task = create_research_task(researcher, final_query)  # ✅ use final_query
...
#             st.session_state.prefill     = ""  # ✅ clear after successful run
...
#     elif run_btn and not final_query:
